...
const DAYS = [
  {
    ...
    duration: null,
    description:
      "Get access to the platform, complete your profile, and prepare for Day 1.",
    output: null,
    vipNote: null,
    capstone: false,
  },
      ...
      <Section id="curriculum" spacing="loose">
              ...
              <div className="flex flex-row items-start gap-3 lg:flex-col lg:gap-3 lg:pt-0.5">
                <span
                  className={`font-ptsans text-sm font-bold uppercase tracking-wider ${
                    d.capstone ? "text-white" : "text-white/50"
                  }`}
                >
                  {d.day}
                </span>
                ...
                <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1">
                  <h3
                    className={`font-ptsans text-lg font-bold uppercase tracking-tight ${
                      d.capstone ? "text-white" : "text-white/90"
                    }`}
                  >
                    {d.name}
                  </h3>
        ...
        <div className="mt-8 flex flex-wrap gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-white/35">Self-paced</span>
          </div>
          <div className="flex items-center gap-2">
